...
/**
 * Wrapper for {@link com.google.gson.Gson}.
...
public class GsonXml {
  ...
  GsonXml(final Gson gson, final XmlParserCreator xmlParserCreator, final XmlReader.Options options) {
   ...
   *
   * @throws com.google.gson.JsonIOException if there was a problem writing to the Reader
