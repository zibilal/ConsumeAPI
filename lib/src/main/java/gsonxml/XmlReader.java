...
public class XmlReader extends JsonReader {
  ...
  private static enum Scope {
    /** We are inside an object. Next token should be {@link com.google.gson.stream.JsonToken#NAME} or {@link com.google.gson.stream.JsonToken#END_OBJECT}. */
    INSIDE_OBJECT(false),
    /** We are inside an array. Next token should be {@link com.google.gson.stream.JsonToken#BEGIN_OBJECT} or {@link com.google.gson.stream.JsonToken#END_ARRAY}. */
    INSIDE_ARRAY(true),
    /** We are inside automatically added array. Next token should be {@link com.google.gson.stream.JsonToken#BEGIN_OBJECT} or {@link com.google.gson.stream.JsonToken#END_ARRAY}. */
    ...
    /** We are inside primitive value. Next token should be {@link com.google.gson.stream.JsonToken#STRING} or {@link com.google.gson.stream.JsonToken#END_ARRAY}. */
    PRIMITIVE_VALUE(false),
    /** New start tag met, we returned {@link com.google.gson.stream.JsonToken#NAME}. Object, array, or value can go next. */
    NAME(false);
